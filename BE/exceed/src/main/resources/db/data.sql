...
VALUES (1, '2023-12-01 08:00:00', '2023-12-01 08:00:00', 'NOT_ACTIVE', 30, '비고 없음', 1, 175.0, 'testId1234+GUEST',
...
VALUES (1, 200.0, 30.0, 10.0, '과일', '사과', 2.0, 120.0, '사과'),
       ...
       (48, 100.0, 143.0, 8.0, '구이류', '더블 체다 함박 스테이크', 12.0, 7.0, '육류구이'),
       (49, 100.0, 248.52, 7.6, '구이류', '돼지갈비', 19.95, 14.7, '육류구이'),
       (50, 170.0, 339.0, 2.6, '구이류', '돼지고기산적', 49.4, 14.6, '육류구이'),
       (51, 200.0, 449.0, 8.1, '구이류', '돼지불고기', 29.7, 33.1, '육류구이'),
       (52, 200.0, 388.0, 0.3, '구이류', '등심스테이크', 60.4, 16.1, '육류구이'),
       (53, 250.0, 762.99, 26.61, '구이류', '떡갈비', 43.08, 51.58, '육류구이'),
       (54, 160.0, 484.0, 5.2, '구이류', '런천미트구이', 28.1, 39.0, '육류구이'),
       (55, 100.0, 179.0, 9.0, '구이류', '레드 칠리 스테이크', 11.0, 11.0, '육류구이'),
       (56, 100.0, 128.0, 5.0, '구이류', '레드와인소스스테이크', 9.0, 8.0, '육류구이'),
       (57, 200.0, 805.0, 25.3, '구이류', '삼겹살고추장구이', 28.4, 65.7, '육류구이'),
       (58, 200.0, 933.0, 0.7, '구이류', '삼겹살구이', 45.1, 83.4, '육류구이'),
       (59, 300.0, 722.0, 4.8, '구이류', '소갈비구이', 77.7, 43.7, '육류구이'),
       (60, 100.0, 124.0, 4.0, '구이류', '소고기 찹스테이크', 9.0, 8.0, '육류구이'),
       (61, 150.0, 639.11, 6.51, '구이류', '소곱창구이', 35.62, 51.71, '육류구이'),
       (62, 200.0, 174.73, 19.63, '구이류', '소불고기', 14.22, 4.68, '육류구이'),
       (63, 300.0, 986.92, 27.74, '구이류', '소양념갈비구이', 61.97, 66.48, '육류구이'),
       (64, 200.0, 366.0, 0.2, '구이류', '안심스테이크', 69.6, 9.7, '육류구이');
