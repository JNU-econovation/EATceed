...
VALUES (1, '2023-12-01 08:00:00', '2023-12-01 08:00:00', 'NOT_ACTIVE', 30, '비고 없음', 1, 175.0, 61.0, 'abcd1111!@gmail.com',
        '$2a$10$BmdXu4CMgwFSv6ZaePB4xuTmd9OERRu5oN7aDc0eukdMbAkG4sqwi', 'MEMBER', true);
...
INSERT INTO FOOD_TB (FOOD_PK, FOOD_CALORIE, FOOD_CARBOHYDRATE, FOOD_FAT, FOOD_NAME, FOOD_PROTEIN,
                     FOOD_SERVING_SIZE, FOOD_SUGARS, FOOD_DIETARY_FIBER, FOOD_SODIUM)
VALUES (1, 200.0, 30.0, 10.0, '사과', 2.0, 120.0, 3.1, 2.3,500),
       (2, 300.0, 40.0, 20.0, '바나나', 3.0, 120.0, 3.1, 2.3,500),
       (3, 400.0, 50.0, 30.0, '포도', 4.0, 120.0, 3.1, 2.3,500),
       (4, 500.0, 60.0, 40.0, '수박', 5.0, 120.0, 3.1, 2.3,500),
       (5, 600.0, 70.0, 50.0, '딸기', 6.0, 120.0, 3.1, 2.3,500),
       (6, 700.0, 80.0, 60.0, '복숭아', 7.0, 120.0, 3.1, 2.3,500),
       (7, 800.0, 90.0, 70.0, '오렌지', 8.0, 120.0, 3.1, 2.3,500),
       (8, 900.0, 10.0, 80.0, '키위', 9.0, 120.0, 3.1, 2.3,500),
       (9, 1000.0, 20.0, 90.0, '체리', 10.0, 120.0, 3.1, 2.3,500),
       (10, 1100.0, 30.0, 100.0, '레몬', 11.0, 120.0, 3.1, 2.3,500),
       (11, 1200.0, 40.0, 110.0, '자몽', 12.0, 120.0, 3.1, 2.3,500),
       (12, 1300.0, 50.0, 120.0, '망고', 13.0, 120.0, 3.1, 2.3,500),
       (13, 1400.0, 60.0, 130.0, '파인애플', 14.0, 120.0, 3.1, 2.3,500),
       (14, 1500.0, 70.0, 140.0, '아보카도', 15.0, 120.0, 3.1, 2.3,500),
       (15, 1600.0, 80.0, 150.0, '망고스틴', 16.0, 120.0, 3.1, 2.3,500),
       (16, 1700.0, 90.0, 160.0, '파파야', 17.0, 120.0, 3.1, 2.3,500),
       (17, 1800.0, 10.0, 170.0, '블루베리', 18.0, 120.0, 3.1, 2.3,500),
       (18, 1900.0, 20.0, 180.0, '라즈베리', 19.0, 120.0, 3.1, 2.3,500),
       (19, 2000.0, 30.0, 190.0, '블랙베리', 20.0, 120.0, 3.1, 2.3,500),
       (20, 200.0, 245.0, 1.3, '가자미구이', 37.4, 10.0, 3.1, 2.3,500),
       (21, 200.0, 275.0, 1.2, '갈치구이', 43.1, 11.0, 3.1, 2.3,500),
       (22, 200.0, 551.0, 0.4, '고등어구이', 47.7, 40.0, 3.1, 2.3,500),
       (23, 200.0, 679.0, 7.6, '고등어석쇠구이', 46.7, 51.4, 3.1, 2.3,500),
       (24, 150.0, 291.0, 0.1, '굴비구이', 28.0, 19.9, 3.1, 2.3,500),
       (25, 200.0, 604.0, 4.3, '꽁치구이', 49.4, 43.4, 3.1, 2.3,500),
       (26, 250.0, 397.0, 2.1, '도미구이', 61.1, 16.5, 3.1, 2.3,500),
       (27, 70.0, 261.0, 17.6, '뱅어포구이', 24.1, 10.6, 3.1, 2.3,500),
       (28, 250.0, 488.0, 0.2, '병어구이', 54.6, 30.8, 3.1, 2.3,500),
       (29, 100.0, 296.54, 11.6, '붕장어소금구이', 26.0, 16.2, 3.1, 2.3,500),
       (30, 200.0, 355.71, 8.48, '삼치구이', 37.83, 18.01, 3.1, 2.3,500),
       (31, 180.0, 260.0, 5.1, '새우구이', 42.1, 8.0, 3.1, 2.3,500),
       (32, 150.0, 433.35, 8.8, '양념장어구이', 30.77, 30.56, 3.1, 2.3,500),
       (33, 250.0, 494.0, 3.5, '임연수구이', 53.8, 29.4, 3.1, 2.3,500),
       (34, 180.0, 460.0, 36.4, '조기구이', 34.8, 19.5, 3.1, 2.3,500),
       (35, 5.0, 23.0, 1.4, '조미김', 1.0, 1.5, 3.1, 2.3,500),
       (36, 70.0, 238.0, 37.4, '쥐포구이', 21.7, 0.2, 3.1, 2.3,500),
       (37, 200.0, 326.21, 2.3, '짚불구이곰장어', 42.7, 16.2, 3.1, 2.3,500),
       (38, 180.0, 346.0, 2.5, '참치머리구이', 47.8, 16.2, 3.1, 2.3,500),
       (39, 180.0, 234.0, 18.8, '키조개구이', 31.4, 3.7, 3.1, 2.3,500),
       (40, 200.0, 437.57, 26.9, '황태구이', 47.8, 15.4, 3.1, 2.3,500),
       (41, 300.0, 740.0, 10.6, '간장양념닭다리구이', 68.9, 46.9, 3.1, 2.3,500),
       (42, 100.0, 142.0, 3.0, '그레이프 소스 스테이크', 10.0, 10.0, 3.1, 2.3,500),
       (43, 500.0, 368.8, 39.7, '꿩불고기', 33.5, 8.5, 3.1, 2.3,500),
       (44, 170.0, 416.0, 17.6, '닭고기대파꼬치구이', 30.3, 25.0, 3.1, 2.3,500),
       (45, 340.0, 872.0, 26.5, '닭구이', 89.1, 45.5, 3.1, 2.3,500),
       (46, 70.0, 177.51, 12.9, '닭꼬치', 12.35, 7.9, 3.1, 2.3,500),
       (47, 220.0, 431.0, 21.3, '닭발구이', 39.9, 20.7, 3.1, 2.3,500),
       (48, 220.0, 431.0, 21.3, '양구이', 39.9, 20.7, 3.1, 2.3,500),
       (49, 220.0, 431.0, 21.3, '소구이', 39.9, 20.7, 3.1, 2.3,500),
       (50, 220.0, 431.0, 21.3, '토끼구이', 39.9, 20.7, 3.1, 2.3,500),
       (51, 220.0, 431.0, 21.3, '멧돼지구이', 39.9, 20.7, 3.1, 2.3,500),
       (52, 220.0, 431.0, 21.3, '참새구이', 39.9, 20.7, 3.1, 2.3,500),
       (53, 100.0, 143.0, 8.0, '더블 체다 함박 스테이크', 12.0, 7.0, 3.1, 2.3,500),
       (54, 100.0, 248.52, 7.6, '돼지갈비', 19.95, 14.7, 3.1, 2.3,500),
       (55, 170.0, 339.0, 2.6, '돼지고기산적', 49.4, 14.6, 3.1, 2.3,500),
       (56, 200.0, 449.0, 8.1, '돼지불고기', 29.7, 33.1, 3.1, 2.3,500);
