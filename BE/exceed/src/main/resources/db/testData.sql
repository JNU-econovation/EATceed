INSERT INTO MEMBER_TB (MEMBER_PK, CREATED_DATE, UPDATED_DATE, MEMBER_ACTIVITY, MEMBER_AGE, MEMBER_ETC, MEMBER_GENDER,
                       MEMBER_HEIGHT, MEMBER_EMAIL, MEMBER_PASSWORD, MEMBER_ROLE, MEMBER_CHECKED)
VALUES (1, '2023-12-01 08:00:00', '2023-12-01 08:00:00', 'NOT_ACTIVE', 30, '비고 없음', 1, 175.0, 'abcd1111!@gmail.com',
        '$2a$10$BmdXu4CMgwFSv6ZaePB4xuTmd9OERRu5oN7aDc0eukdMbAkG4sqwi', 'MEMBER', false);

INSERT INTO WEIGHT_TB (WEIGHT_PK, CREATED_DATE, UPDATED_DATE, WEIGHT_WEIGHT, WEIGHT_TARGET_WEIGHT, MEMBER_FK)
VALUES (1, '2023-12-01 08:00:00', '2023-12-01 08:00:00', 70.0, 0.0, 1);
