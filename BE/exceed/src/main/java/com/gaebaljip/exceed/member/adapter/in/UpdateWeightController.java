...
public class UpdateWeightController {
    ...
    public ApiResponse<UpdateWeightResponse> updateWeight(UpdateWeightRequest request, @AuthenticationMemberId Long memberId) {
        return ApiResponseGenerator.success(updateWeightService.execute(UpdateWeightCommand.of(request.weight(), request.targetWeight(), memberId)), HttpStatus.OK);
    }
}
