...
public class UpdateMemberService implements UpdateMemberUsecase {
    ...
    public void execute(UpdateMemberCommand command) {
        ...
        member.updateMember(command.height(), Gender.valueOf(command.gender()), command.age(),
                Activity.valueOf(command.activity()), command.etc(), command.weight(), command.targetWeight());
    }
}
