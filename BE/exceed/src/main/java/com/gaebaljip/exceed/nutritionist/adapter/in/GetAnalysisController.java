...
public class GetAnalysisController {
    ...
    public ApiResponse<ApiResponse.CustomBody<GetAnalysisResponse>> getAnalysis(@PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate date, @Parameter(hidden = true) @AuthenticationMemberId Long memberId) {
