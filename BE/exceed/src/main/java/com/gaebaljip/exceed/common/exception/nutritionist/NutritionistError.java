...
public enum NutritionistError implements BaseError {
    INVALID_MEAL(400, "3000", "존재하지 않는 식사입니다."),
    NOT_SAME_YEAR_MONTH(500, "3001", "모든 날짜의 연도와 월은 같아야합니다."),
    NOT_SAME_SIZE(500, "3002", "해당 월의 일수와 size가 같아야합니다."),
    NOT_REQUIRED_MINIMUM_MEMBER(500, "3003", "회원이 1개 이상 있어야합니다.");
