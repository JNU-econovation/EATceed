...
# bearer token 해석 
# oauth2_scheme = OAuth2PasswordBearer(tokenUrl="http://localhost:8080/v1/auth/login")
...
#         logger.debug(f"Decoded payload from token: {decoded_payload}")  # 디코딩된 페이로드 디버그 출력
